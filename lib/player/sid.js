...
var __line = 1
  ...
  , __filename = "lib/player/songcmds.asm";
try {
...
var __line = 1
  ...
  , __filename = "lib/player/seqcmds.asm";
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
...
var __line = 1
  ...
  , __filename = "lib/player/main.asm";
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
    ; 
  ...
  function byteTable(values) {
    ...
    ; __append("\n\n  rts\n\n\nupdate_sid_regs:\n  ldx #2\n  ldy #0\n_upd_loop:\n  lda sid_freq_lo, x\n  sta $d400, y\n  lda sid_freq_hi, x\n  sta $d401, y\n  lda sid_pw_lo, x\n  sta $d402, y\n  lda sid_pw_hi, x\n  sta $d403, y\n  lda sid_control, x\n  sta $d404, y\n  lda sid_ad, x\n  sta $d405, y\n  lda sid_sr, x\n  sta $d406, y\n  tya\n  adc #7\n  tay\n  dex\n  bpl _upd_loop\n\n  lda sid_fc_lo\n  sta $d415\n  lda sid_fc_hi\n  sta $d416\n  lda sid_flt_res\n  sta $d417\n  lda sid_vol_mode\n  sta $d418\n\n  rts\n\n\nplay_channel:\n  stx ZP_CHANNEL        ; save channel\n\n  lda finished, x\n  bne _done             ; branch if finished\n\n  lda playing, x\n  beq _fetch_loop       ; branch if not playing note\n\n  ;; decrement quantization length counter\n  ldy qlen_c_lo, x\n  lda qlen_c_hi, x\n  cpy #$01\n  dey\n  sbc #0\n  sta ZP_TEMP\n  tya\n  sta qlen_c_lo, x\n  lda ZP_TEMP\n  sta qlen_c_hi, x\n  bcs _dec_nlen_c       ; branches if qlen_c >= 0\n\n  ;; gate off\n  lda wave, x\n  sta sid_control, x\n\n_dec_nlen_c:\n  ;; decrement note length counter\n  ldy nlen_c_lo, x\n  lda nlen_c_hi, x\n  cpy #$01\n  dey\n  sbc #0\n  sta ZP_TEMP\n  tya\n  sta nlen_c_lo, x\n  lda ZP_TEMP\n  sta nlen_c_hi, x\n  bcc _stop_playing     ; branches if nlen_c < 0\n  jmp _play_sequences\n\n_stop_playing:\n  ;; stop playing\n  lda #0\n  sta playing, x\n\n_fetch_loop:\n  jsr fetch_song_byte\n\n  cmp #I_EOF\n  bne _check_note       ; branch if cmd != I_EOF\n  lda #1\n  sta finished, x       ; mark channel as finished\n  rts\n\n_check_note:\n  cmp #$80\n  bcc _play_note        ; branch if cmd < $80\n\n  ;; instruction is a command: use jump table\n  jsr opcode_launcher\n\n  lda #0\n  beq _fetch_loop       ; keep fetching and decoding instructions\n                        ; until a note is reached\n_done:\n  rts\n\n_play_note:\n  ldx ZP_CHANNEL\n\n  ;; convert relative to absolute note, transpose it\n  pha\n  and #%00001111\n  cmp #I_NOTE_REST\n  beq _reload_counters\n\n  ;; add octave\n  clc\n  adc octave_n, x\n  adc transpose, x\n\n  ;; load freq of new note\n  tay\n  lda freq_lo, y\n  sta sid_freq_lo, x\n  lda freq_hi, y\n  sta sid_freq_hi, x\n\n  ;; gate on\n  ldy wave, x\n  iny           ; enable gate\n  tya\n  sta sid_control, x\n\n_reload_counters:\n  pla\n  and #%01110000\n  sta ZP_TEMP\n\n  cmp #WITH_LEN_FLAG\n  beq _note_with_len\n\n  ;; reload frame counters with default lengths\n  lda nlen_lo, x\n  sta nlen_c_lo, x\n  lda nlen_hi, x\n  sta nlen_c_hi, x\n  jmp _reload_q_counters\n\n_note_with_len:\n  ;; reload note length counter with operand\n  jsr fetch_song_byte\n  sta nlen_c_lo, x\n  lda ZP_TEMP\n  and #WORD_FLAG\n  beq _skip_len_hi\n  jsr fetch_song_byte\n_skip_len_hi:\n  sta nlen_c_hi, x\n\n_reload_q_counters:\n  lda ZP_TEMP\n  cmp #WITH_Q_FLAG\n  beq _note_with_quant\n\n  ;; reload quantization frame counters with defaults\n  lda qlen_lo, x\n  sta qlen_c_lo, x\n  lda qlen_hi, x\n  sta qlen_c_hi, x\n  jmp _reset_sequence_indexes\n\n_note_with_quant:\n  ;; reload note length counter with operand\n  jsr fetch_song_byte\n  sta qlen_c_lo, x\n  lda ZP_TEMP\n  and #WORD_FLAG\n  beq _skip_q_hi\n  jsr fetch_song_byte\n_skip_q_hi:\n  sta qlen_c_hi, x\n\n_reset_sequence_indexes:\n  lda #0\n  ;; TODO Do it for all sequences\n  sta pw_seq + SEQ_I, x\n\n  lda #1\n  sta playing, x\n\n_play_sequences:\n  ;; TODO Do it for all sequences\n\n  ;; ************************************************\n  lda #<pw_seq\n  sta ZP_PTR_LO\n  lda #>pw_seq\n  sta ZP_PTR_HI\n\n  lda pw_seq + SEQ_LO, x\n  sta ZP_SEQ_LO\n  lda pw_seq + SEQ_HI, x\n  sta ZP_SEQ_HI\n  lda pw_seq + SEQ_I, x\n  sta ZP_SEQ_I\n\n  jsr play_sequence\n\n  ldy seq_value_lo, x\n  lda (ZP_PTR_LO), y\n  sta sid_pw_lo, x\n\n  ldy seq_value_hi, x\n  lda (ZP_PTR_LO), y\n  sta sid_pw_hi, x\n\n  lda ZP_SEQ_I\n  sta pw_seq + SEQ_I, x\n  ;; ************************************************\n\n  rts\n\n\nfetch_song_byte:\n  ; fetch value and store it\n  lda song_ptr_lo, x\n  sta ZP_PTR_LO\n  lda song_ptr_hi, x\n  sta ZP_PTR_HI\n  ldy #0\n  lda (ZP_PTR_LO), y\n  pha\n\n  ;; increment song_ptr\n  lda song_ptr_hi, x\n  ldy song_ptr_lo, x\n  cpy #$ff\n  iny\n  adc #0\n  pha\n  tya\n  sta song_ptr_lo, x\n  pla\n  sta song_ptr_hi, x\n\n  pla\n  rts\n\n\nplay_sequence:\n  ldy seq_counter, x\n  lda (ZP_PTR_LO), y\n  beq _next_seq_byte          ; branch if counter is already 0\n\n  tay\n  dey                         ; decrement counter\n  tya\n  ldy seq_counter, x\n  sta (ZP_PTR_LO), y          ; update counter field\n  beq _next_seq_byte          ; if counter reaches 0, advance\n\n  ldy seq_step, x\n  lda (ZP_PTR_LO), y\n  sta ZP_TEMP                 ; get step value\n  bne _add_step_value\n  rts\n\n_add_step_value:\n  ;; add step to sequence value\n  ldy seq_value_lo, x\n  lda (ZP_PTR_LO), y\n  adc ZP_TEMP\n  sta (ZP_PTR_LO), y\n\n  ldy seq_value_hi, x\n  lda (ZP_PTR_LO), y\n  adc #0\n  sta (ZP_PTR_LO), y\n  rts\n\n_next_seq_byte:\n  jsr fetch_seq_byte\n  cmp #I_EOF\n  beq _play_seq_done\n\n  jmp opcode_seq_launcher\n\n_play_seq_done:\n  ;; if jump marker is != $ff, set index to SEQ_JMP\n  ldx ZP_CHANNEL\n  ldy seq_jmp, x\n  lda (ZP_PTR_LO), y          ; get jump marker index\n  cmp #$ff\n  beq _seq_done\n\n  sta ZP_SEQ_I                ; use jump marker index as current index\n  jmp _next_seq_byte\n\n_seq_done:\n  rts\n\n\nfetch_seq_byte:\n  ldy ZP_SEQ_I\n  lda (ZP_SEQ_LO), y      ; get sequence byte with index\n  cmp #I_EOF\n  beq _fetch_seq_done     ; branch if sequence ended\n  iny\n  sty ZP_SEQ_I            ; increment index\n_fetch_seq_done:\n  rts\n\n")
    ; __line = 436
    ; __append(include("songcmds.asm"))
    ; __append("\n")
    ; __line = 437
    ; __append(include("seqcmds.asm"))
    ; __append("\n\n;; === data ===\n\n;; ghost registers by channel\nsid_freq_lo:  .byte 0, 0, 0\nsid_freq_hi:  .byte 0, 0, 0\nsid_pw_lo:    .byte 0, 0, 0\nsid_pw_hi:    .byte $8, $8, $8\nsid_control:  .byte 0, 0, 0\nsid_ad:       .byte $08, $70, $80\nsid_sr:       .byte $40, $e1, $e1\n\n;; ghost registers for all channels\nsid_fc_lo:    .byte 0\nsid_fc_hi:    .byte 0\nsid_flt_res:  .byte 0\nsid_vol_mode: .byte $0c\n\n;; song pointers\nsong_ptr_lo: .byte <song0, <song1, <song2\nsong_ptr_hi: .byte >song0, >song1, >song2\nplaying:     .byte 0, 0, 0\nfinished:    .byte 0, 0, 0\n\n;; more state vars\nnlen_lo:   .byte 23, 23, 23\nnlen_hi:   .byte 0, 0, 0\nqlen_lo:   .byte 23, 23, 23\nqlen_hi:   .byte 0, 0, 0\noctave_n:  .byte 12*3, 12*3, 12*3\ntranspose: .byte 0, 0, 0\npitch:     .byte 0, 0, 0\nwave:      .byte $10, $10, $10\n\n;; counters\nnlen_c_lo: .byte 0, 0, 0\nnlen_c_hi: .byte 0, 0, 0\nqlen_c_lo: .byte 0, 0, 0\nqlen_c_hi: .byte 0, 0, 0\n\n;; loop stacks (8 simultaneous loops max, per channel)\nloops_idx:\n  .byte $fd, $fe, $ff\nloops_ptr_lo:\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\nloops_ptr_hi:\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\nloops_c:\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n\npw_seq:     ; word sequence\n  .byte <eof, <eof, <eof\n  .byte >eof, >eof, >eof\n  .byte 0, 0, 0\n  .byte $ff, $ff, $ff\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n  .byte 0, 0, 0\n\n")
    ; __line = 519
    ;  if (debug) { 
    ; __append("\nglobal_counter: .word 0\n")
...
var __line = 1
  ...
  , __filename = "lib/player/prg.asm";
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
    ; __append(".word $0801\n* = $0801\n\n; autostart routine\n.word $080b, 2015\n.byte $9e, \"2061\", 0, 0, 0\n\nmain:\n    sei\n\n    ldy #$7f          ; $7f = %01111111\n    sty $dc0d         ; turn off CIAs Timer interrupts ($7f = %01111111)\n    sty $dd0d\n    lda $dc0d         ; by reading $dc0d and $dd0d we cancel all CIA-IRQs\n    lda $dd0d         ; in queue/unprocessed.\n\n    lda #$01          ; set Interrupt Request Mask\n    sta $d01a         ; we want IRQ by Rasterbeam (%00000001)\n\n    lda #<irq         ; point IRQ Vector to our custom irq routine\n    ldx #>irq\n    sta $0314         ; store in $314/$315\n    stx $0315\n\n    lda #$10          ; trigger interrupt at row $10\n    sta $d012\n\n    lda #0\n    sta $d011\n    sta $d020\n    sta $d021\n\n    jsr init\n\n    cli\n    jmp *\n\nirq:\n    dec $d019       ; acknowledge IRQ / clear register for next interrupt\n\n    inc $d020\n    jsr play\n    dec $d020\n\n    jmp $ea31       ; return to Kernel routine\n\n.res $1000 - *\n\n")
    ; __line = 49
    ; __append(include('main.asm', { debug: debug, song: song }))
    ; __append("\n")
    ; __line = 50
  }
  return __output.join("");
...
var __line = 1
  ...
  , __filename = "lib/player/freq/ntsc.asm";
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
...
var __line = 1
  ...
  , __filename = "lib/player/freq/pal.asm";
try {
  var __output = [], __append = __output.push.bind(__output);
  with (locals || {}) {
...
try {
  ...
  with (locals || {}) {
    ; __append(";;\n;; Header for a PSID v2NG file\n;; See http://cpansearch.perl.org/src/LALA/Audio-SID-3.11/SID_file_format.txt\n;;\n;; load address\nBASEADDR = $1000\n;; flags\n;; NOTE when using PAL or NTSC, set also SP_PAL or SP_NTSC in SPEED flag\nF_MISC = 2  ; built-in player\nF_PAL  = 4\nF_NTSC = 8\nF_MOS6581 = 16\nF_MOS8580 = 32\nFLAGS = F_MOS6581 | F_PAL | F_MISC\n;; speed flag\nC_PAL  = 0\nC_NTSC = 1\nCLOCK = C_PAL\n;;\n.aasc \"PSID\"              ; magicId\n.byte 0,2                 ; version\n.byte 0,$7c               ; dataOffset\n.byte >BASEADDR,<BASEADDR ; loadAddress (loadAddress == dataOffset)\n.byte >init,<init         ; initAddress\n.byte >play,<play         ; playAddress\n.byte 0,1                 ; songs\n.byte 0,1                 ; startSong\n.word 0,CLOCK             ; speed\n.aasc \"")
    ; __line = 29
    ; __append(headers.title.padRight(32))
    ; __append("\"\n.aasc \"")
    ; __line = 30
    ; __append(headers.author.padRight(32))
    ; __append("\"\n.aasc \"")
    ; __line = 31
    ; __append(headers.released.padRight(32))
    ; __append("\"\n.byte 0,FLAGS             ; flags (PAL 6581 only)\n.byte 0                   ; startPage\n.byte 0                   ; pageLength\n.byte 0,0                 ; (reserved)\n\n* = BASEADDR\n\n")
    ; __line = 39
    ; __append(include('main.asm', { debug: debug, song: song }))
    ; __append("\n")
